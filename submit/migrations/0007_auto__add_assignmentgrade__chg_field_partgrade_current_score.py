...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'submit_assignmentgrade', (
        ...
        db.send_create_signal(u'submit', ['AssignmentGrade'])


        # Changing field 'PartGrade.current_score'
        db.alter_column(u'submit_partgrade', 'current_score', self.gf('django.db.models.fields.IntegerField')(default=0))

    def backwards(self, orm):
        # Deleting model 'AssignmentGrade'
        db.delete_table(u'submit_assignmentgrade')


        # Changing field 'PartGrade.current_score'
        db.alter_column(u'submit_partgrade', 'current_score', self.gf('django.db.models.fields.IntegerField')(null=True))
