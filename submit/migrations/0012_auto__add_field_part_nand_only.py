...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Part.nand_only'
        db.add_column(u'submit_part', 'nand_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Part.nand_only'
        db.delete_column(u'submit_part', 'nand_only')
    ...
    models = {
        ...
        u'submit.part': {
            ...
            'nand_only': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
